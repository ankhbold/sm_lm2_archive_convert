...
class OwnRecordDialog(QDialog, Ui_OwnRecordDialog, DatabaseHelper):
    ...
    def __save_record(self):
        ...
        try:
            ...
            self.record.certificate_no = self.certificate_number_edit.text()
            self.commit()
    ...
    def on_help_button_clicked(self):
        ...
        if self.tabWidget.currentIndex() == 0:
                os.system("hh.exe "+ str(os.path.dirname(os.path.realpath(__file__))[:-10]) +"help\output\help_lm2.chm::/html/ownership_application.htm")

...
class SentToGovernorDialog(QDialog, Ui_SentToGovernorDialog, DatabaseHelper):
    ...
    def __setup_combo_boxes(self):
        ...
        try:
            ...
            set_role = self.session.query(SetRole).filter(SetRole.user_name == DatabaseUtils.current_user().user_name).one()
    ...
    def on_search_button_clicked(self):
        ...
        try:
            ...
            if not self.officer_cbox.itemData(self.officer_cbox.currentIndex()) == -1:
                officer = "%" + self.officer_cbox.itemData(self.officer_cbox.currentIndex()).user_name + "%"
        ...
        for app in applications:
            ...
            if int(application[6:-9]) == (self.app_type_cbox.itemData(self.app_type_cbox.currentIndex())) and application_instance.app_timestamp >= p_begin_date and application_instance.app_timestamp <= p_end_date:
                ...
                app_person = self.session.query(CtApplicationPersonRole).filter(CtApplicationPersonRole.application == application).all()
                ...
                parce_id = application_instance.tmp_parcel

                item = QTableWidgetItem(parce_id)
                item.setData(Qt.UserRole, application_instance.parcel)
    ...
    def on_draft_print_button_clicked(self):
        ...
        if app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1 and (person.type == 10 or person.type == 20)\
            ...
            template = path + "draft_3_6_1.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 2204 or landuse_type.code == 2205 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            template = path + "draft_3_6_2.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1:
            template = path + "draft_3_7_1.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 30 or person.type == 40):
            template = path + "draft_3_7_2.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 10 or person.type == 20):
            template = path + "draft_3_6_2.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 1501 or landuse_type.code == 1502 or landuse_type.code == 1301 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1401 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            template = path + "draft_3_8_1.qpt"
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 1501 or landuse_type.code == 1502 or landuse_type.code == 1301 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1401 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            template = path + "draft_3_8_2.qpt"
        elif app_type_code == "07" and self.draft_detail_twidget.rowCount() == 1:
            template = path + "draft_4_9_1.qpt"
        elif app_type_code == "07" and self.draft_detail_twidget.rowCount() > 1:
            template = path + "draft_4_9_2.qpt"
        elif app_type_code == "10" and self.draft_detail_twidget.rowCount() == 1:
            template = path + "draft_4_13_1.qpt"
        elif app_type_code == "10" and self.draft_detail_twidget.rowCount() > 1:
            template = path + "draft_4_13_2.qpt"
        elif app_type_code == "06" and self.draft_detail_twidget.rowCount() == 1:
            template = path + "draft_5_16_1.qpt"
        elif app_type_code == "06" and self.draft_detail_twidget.rowCount() > 1:
            template = path + "draft_5_16_2.qpt"
        elif app_type_code == "16" and person.type == 30 and self.draft_detail_twidget.rowCount() == 1 and (landuse_type.code == 2201 or landuse_type.code == 2202\
                or landuse_type.code == 2203):
            template = path + "draft_5_16_3.qpt"
        elif app_type_code == "16" and person.type == 30 and self.draft_detail_twidget.rowCount() > 1 and (landuse_type.code == 2201 or landuse_type.code == 2202\
                or landuse_type.code == 2203):
            template = path + "draft_5_16_4.qpt"
        elif app_type_code == "01" or app_type_code == "03":
            template = path + "draft_6_1.qpt"
        elif app_type_code == "02":
            template = path + "draft_6_2.qpt"
        else:
            return
        ...
        printer.setOutputFileName(path+"draft.pdf")
        ...
        if app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 2204 or landuse_type.code == 2205 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            self.__add_person(map_composition)
            self.__add_parcel_info(map_composition)
            self.__add_officer(map_composition)
            self.__add_soum(map_composition)
            self.__add_bag(map_composition)
        # draft 3_6_2
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 2204 or landuse_type.code == 2205 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            self.__add_person_count(map_composition)
            self.__add_officer(map_composition)
        # draft 3_7_1
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1:
            self.__add_full_name(map_composition)
            self.__add_officer(map_composition)
        # draft 3_7_2
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1:
            self.__add_person_count(map_composition)
            self.__add_officer(map_composition)
        # draft 6_1
        elif (app_type_code == "01" or app_type_code == "03") and self.draft_detail_twidget.rowCount() >= 1 :
            self.__add_officer(map_composition)
            self.__add_soum(map_composition)
        # draft 3_8_1
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() == 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 1501 or landuse_type.code == 1502 or landuse_type.code == 1301 or landuse_type.code == 1302 or landuse_type.code == 1303 \
                        or landuse_type.code == 1304 or landuse_type.code == 1305 or landuse_type.code == 1306 or landuse_type.code == 1401 or landuse_type.code == 1402\
                        or landuse_type.code == 1403 or landuse_type.code == 1404 or landuse_type.code == 1405 or landuse_type.code == 1406):
            self.__add_agr_name(map_composition)
            self.__add_officer(map_composition)
        # draft 3_8_2
        elif app_type_code == "05" and self.draft_detail_twidget.rowCount() > 1 and (person.type == 10 or person.type == 20)\
                and (landuse_type.code == 1501 or landuse_type.code == 1502 or landuse_type.code == 1301 or landuse_type.code == 1302 or landuse_type.code == 1303 \
        ...
        # draft 4_13_1
            ...
            self.__add_extension_date(map_composition)
            self.__add_officer(map_composition)
        # draft 4_13_2
        elif app_type_code == "10" and self.draft_detail_twidget.rowCount() > 1:
            self.__add_officer(map_composition)
            self.__add_person_count()
        # draft 5_16_1
        elif app_type_code == "06" and self.draft_detail_twidget.rowCount() == 1:
            self.__add_use_text(map_composition)
            self.__add_officer(map_composition)
        # draft 5_16_2
        elif app_type_code == "06" and self.draft_detail_twidget.rowCount() > 1:
            self.__add_person_count(map_composition)
        ...
        # draft 6_2
            ...
            self.__add_officer(map_composition)
            self.__add_soum(map_composition)
            self.__add_soum1(map_composition)
            self.__add_bag(map_composition)
        # draft 4_9_1
        elif app_type_code == "07" and self.draft_detail_twidget.rowCount() == 1:
            self.__add_transfer(map_composition)
            self.__add_officer(map_composition)
        # draft 4_9_2
        elif app_type_code == "07" and self.draft_detail_twidget.rowCount() > 1:
            self.__add_trasfer_count(map_composition)
            self.__add_person_count(map_composition)
            self.__add_officer(map_composition)
        # draft 5_16_3
        elif app_type_code == "16" and person.type == 30 and self.draft_detail_twidget.rowCount() == 1 and (landuse_type.code == 2201 or landuse_type.code == 2202\
                or landuse_type.code == 2203):
            self.__add_suh_use(map_composition)
            self.__add_officer(map_composition)
        # draft 5_16_4
        elif app_type_code == "16" and person.type == 30 and self.draft_detail_twidget.rowCount() > 1 and (landuse_type.code == 2201 or landuse_type.code == 2202\
                or landuse_type.code == 2203):
        ...
        if message_box.clickedButton() == yes_button:
            ...
            map_composition.exportAsPDF(path + "draft.pdf")
            try:
                QDesktopServices.openUrl(QUrl.fromLocalFile(path+"draft.pdf"))
            except IOError, e:
                PluginUtils.show_error(self, self.tr("Out error"), self.tr("This file is already opened. Please close re-run"))
    ...
    def __add_person(self, map_composition):
        ...
        #
        # except SQLAlchemyError, e:
        #     raise LM2Exception(self.tr(""), self.tr("aCould nor execute: {0}").format(e.message))
    def __add_officer(self,map_composition):
        ...
        try:
            user = self.session.query(SetRole).filter(SetRole.user_name == user_name).one()
        except SQLAlchemyError, e:
            self.rollback()
            PluginUtils.show_error(self, self.tr("Query Error"), self.tr("Error in line {0}: {1}").format(currentframe().f_lineno, e.message))
            return

...
class Ui_PdfInsertDialog(object):
    def setupUi(self, PdfInsertDialog):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 5, 431, 491))
        ...
        self.files_twidget.setGeometry(QtCore.QRect(10, 70, 401, 341))
        ...
        self.close_button.setGeometry(QtCore.QRect(370, 500, 75, 23))
    ...
    def retranslateUi(self, PdfInsertDialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("PdfInsertDialog", "Image Compressor", None))

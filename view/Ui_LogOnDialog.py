...
#
# Created: Wed Aug 20 09:16:54 2014
...
class Ui_LogOnDialog(object):
    def setupUi(self, LogOnDialog):
        ...
        LogOnDialog.setTabOrder(self.password_edit, self.help_button)
        LogOnDialog.setTabOrder(self.help_button, self.logon_button)
        LogOnDialog.setTabOrder(self.logon_button, self.close_button)
